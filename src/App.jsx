      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-5 border-b border-white/10 backdrop-blur-xl">
        <div>
          <h1 className="text-2xl font-bold tracking-wide">
            NETRUNFIBER<span className="text-cyan-400">NET</span>
          </h1>
        </div>
      ...
      <section className="relative z-10 px-6 py-24 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-gray-400 text-lg leading-relaxed max-w-xl mb-8">
            Experience blazing fast speeds, zero buffering, and seamless connectivity powered by NETRUNFIBERNet advanced fiber infrastructure.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                NETRUNFIBERNet is rapidly expanding across cities with next-generation fiber infrastructure.
              </p>
